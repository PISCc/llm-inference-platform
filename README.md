...
面向大模型推理系统的交互式技术工作台，集成技术全景图、推理流程动画、参数实验、方案对比、证据驱动诊断、上下文 AI 问答与 PPT 导出。
...
| 模块 | 主要能力 |
| --- | --- |
| 首页 | 汇总推理链路、技术主题、实验入口、方案对比、诊断与 AI 助手 |
...
因此 `dist/index.html` 是包含主要脚本和样式的单文件构建，可以直接打开并使用离线页面功能。
